...
while True:
    ...
    if len(contours) > 0:
        ...
        for cont in contours:
            ...
            approx2 = cv2.approxPolyDP(cont,epsilon,True)
            ...
            if area > 250:
                ...
                if(edge_count==4):
                    ...
                    center_y = y+h/2
                    cv2.circle(frame,(int(center_x),int(center_y)),5,(255,0,0),-1)
                    cv2.putText(frame,"Weight",(x,y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),2)
...
def getBorderDominantColor(x,y,w,h):
    border_dominant_color = {}
    histograms = {}
    shape_colors = ('b','g','r')
    border_colors = ('b','g','r')
    ...
    return [color_names[border_dominant_index],color_names[border_dominant_index2]]
